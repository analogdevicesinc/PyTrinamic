...
from ..ic import TMCIc, Access, RegisterGroup, Field, Register

class TMC4671Core(TMCIc):

    def __init__(self, info=None):
        super().__init__("TMC4671", info)
        self.register = self._Register()

    class _Register(RegisterGroup):

        def __init__(self):
            super().__init__("None")
            self.CHIPINFO_DATA = _CHIPINFO_DATA(self, Access.R, 0x0000, False)
            self.CHIPINFO_ADDR = _CHIPINFO_ADDR(self, Access.RW, 0x0001, False)
            self.ADC_RAW_DATA = _ADC_RAW_DATA(self, Access.R, 0x0002, False)
            self.ADC_RAW_ADDR = _ADC_RAW_ADDR(self, Access.RW, 0x0003, False)
            self.dsADC_MCFG_B_MCFG_A = _dsADC_MCFG_B_MCFG_A(self, Access.RW, 0x0004, False)
            self.dsADC_MCLK_A = _dsADC_MCLK_A(self, Access.RW, 0x0005, False)
            self.dsADC_MCLK_B = _dsADC_MCLK_B(self, Access.RW, 0x0006, False)
            self.dsADC_MDEC_B_MDEC_A = _dsADC_MDEC_B_MDEC_A(self, Access.RW, 0x0007, False)
            self.ADC_I1_SCALE_OFFSET = _ADC_I1_SCALE_OFFSET(self, Access.RW, 0x0008, False)
            self.ADC_I0_SCALE_OFFSET = _ADC_I0_SCALE_OFFSET(self, Access.RW, 0x0009, False)
            self.ADC_I_SELECT = _ADC_I_SELECT(self, Access.RW, 0x000A, False)
            self.ADC_I1_I0_EXT = _ADC_I1_I0_EXT(self, Access.RW, 0x000B, False)
            self.DS_ANALOG_INPUT_STAGE_CFG = _DS_ANALOG_INPUT_STAGE_CFG(self, Access.RW, 0x000C, False)
            self.AENC_0_SCALE_OFFSET = _AENC_0_SCALE_OFFSET(self, Access.RW, 0x000D, False)
            self.AENC_1_SCALE_OFFSET = _AENC_1_SCALE_OFFSET(self, Access.RW, 0x000E, False)
            self.AENC_2_SCALE_OFFSET = _AENC_2_SCALE_OFFSET(self, Access.RW, 0x000F, False)
            self.AENC_SELECT = _AENC_SELECT(self, Access.RW, 0x0011, False)
            self.ADC_IWY_IUX = _ADC_IWY_IUX(self, Access.R, 0x0012, False)
            self.ADC_IV = _ADC_IV(self, Access.R, 0x0013, True)
            self.AENC_WY_UX = _AENC_WY_UX(self, Access.R, 0x0015, False)
            self.AENC_VN = _AENC_VN(self, Access.R, 0x0016, True)
            self.PWM_POLARITIES = _PWM_POLARITIES(self, Access.RW, 0x0017, False)
            self.PWM_MAXCNT = _PWM_MAXCNT(self, Access.RW, 0x0018, False)
            self.PWM_BBM_H_BBM_L = _PWM_BBM_H_BBM_L(self, Access.RW, 0x0019, False)
            self.PWM_SV_CHOP = _PWM_SV_CHOP(self, Access.RW, 0x001A, False)
            self.MOTOR_TYPE_N_POLE_PAIRS = _MOTOR_TYPE_N_POLE_PAIRS(self, Access.RW, 0x001B, False)
            self.PHI_E_EXT = _PHI_E_EXT(self, Access.RW, 0x001C, True)
            self.OPENLOOP_MODE = _OPENLOOP_MODE(self, Access.RW, 0x001F, False)
            self.OPENLOOP_ACCELERATION = _OPENLOOP_ACCELERATION(self, Access.RW, 0x0020, False)
            self.OPENLOOP_VELOCITY_TARGET = _OPENLOOP_VELOCITY_TARGET(self, Access.RW, 0x0021, True)
            self.OPENLOOP_VELOCITY_ACTUAL = _OPENLOOP_VELOCITY_ACTUAL(self, Access.RW, 0x0022, True)
            self.OPENLOOP_PHI = _OPENLOOP_PHI(self, Access.RW, 0x0023, True)
            self.UQ_UD_EXT = _UQ_UD_EXT(self, Access.RW, 0x0024, False)
            self.ABN_DECODER_MODE = _ABN_DECODER_MODE(self, Access.RW, 0x0025, False)
            self.ABN_DECODER_PPR = _ABN_DECODER_PPR(self, Access.RW, 0x0026, False)
            self.ABN_DECODER_COUNT = _ABN_DECODER_COUNT(self, Access.RW, 0x0027, False)
            self.ABN_DECODER_COUNT_N = _ABN_DECODER_COUNT_N(self, Access.RW, 0x0028, False)
            self.ABN_DECODER_PHI_E_PHI_M_OFFSET = _ABN_DECODER_PHI_E_PHI_M_OFFSET(self, Access.RW, 0x0029, False)
            self.ABN_DECODER_PHI_E_PHI_M = _ABN_DECODER_PHI_E_PHI_M(self, Access.R, 0x002A, False)
            self.ABN_2_DECODER_MODE = _ABN_2_DECODER_MODE(self, Access.RW, 0x002C, False)
            self.ABN_2_DECODER_PPR = _ABN_2_DECODER_PPR(self, Access.RW, 0x002D, False)
            self.ABN_2_DECODER_COUNT = _ABN_2_DECODER_COUNT(self, Access.RW, 0x002E, False)
            self.ABN_2_DECODER_COUNT_N = _ABN_2_DECODER_COUNT_N(self, Access.RW, 0x002F, False)
            self.ABN_2_DECODER_PHI_M_OFFSET = _ABN_2_DECODER_PHI_M_OFFSET(self, Access.RW, 0x0030, True)
            self.ABN_2_DECODER_PHI_M = _ABN_2_DECODER_PHI_M(self, Access.R, 0x0031, True)
            self.HALL_MODE = _HALL_MODE(self, Access.RW, 0x0033, False)
            self.HALL_POSITION_060_000 = _HALL_POSITION_060_000(self, Access.RW, 0x0034, False)
            self.HALL_POSITION_180_120 = _HALL_POSITION_180_120(self, Access.RW, 0x0035, False)
            self.HALL_POSITION_300_240 = _HALL_POSITION_300_240(self, Access.RW, 0x0036, False)
            self.HALL_PHI_E_PHI_M_OFFSET = _HALL_PHI_E_PHI_M_OFFSET(self, Access.RW, 0x0037, False)
            self.HALL_DPHI_MAX = _HALL_DPHI_MAX(self, Access.RW, 0x0038, False)
            self.HALL_PHI_E_INTERPOLATED_PHI_E = _HALL_PHI_E_INTERPOLATED_PHI_E(self, Access.R, 0x0039, False)
            self.HALL_PHI_M = _HALL_PHI_M(self, Access.R, 0x003A, True)
            self.AENC_DECODER_MODE = _AENC_DECODER_MODE(self, Access.RW, 0x003B, False)
            self.AENC_DECODER_N_THRESHOLD = _AENC_DECODER_N_THRESHOLD(self, Access.RW, 0x003C, False)
            self.AENC_DECODER_PHI_A_RAW = _AENC_DECODER_PHI_A_RAW(self, Access.R, 0x003D, True)
            self.AENC_DECODER_PHI_A_OFFSET = _AENC_DECODER_PHI_A_OFFSET(self, Access.RW, 0x003E, True)
            self.AENC_DECODER_PHI_A = _AENC_DECODER_PHI_A(self, Access.R, 0x003F, True)
            self.AENC_DECODER_PPR = _AENC_DECODER_PPR(self, Access.RW, 0x0040, True)
            self.AENC_DECODER_COUNT = _AENC_DECODER_COUNT(self, Access.RW, 0x0041, True)
            self.AENC_DECODER_COUNT_N = _AENC_DECODER_COUNT_N(self, Access.RW, 0x0042, True)
            self.AENC_DECODER_PHI_E_PHI_M_OFFSET = _AENC_DECODER_PHI_E_PHI_M_OFFSET(self, Access.RW, 0x0045, False)
            self.AENC_DECODER_PHI_E_PHI_M = _AENC_DECODER_PHI_E_PHI_M(self, Access.R, 0x0046, False)
            self.CONFIG_DATA = _CONFIG_DATA(self, Access.RW, 0x004D, True)
            self.CONFIG_ADDR = _CONFIG_ADDR(self, Access.RW, 0x004E, False)
            self.VELOCITY_SELECTION = _VELOCITY_SELECTION(self, Access.RW, 0x0050, False)
            self.POSITION_SELECTION = _POSITION_SELECTION(self, Access.RW, 0x0051, False)
            self.PHI_E_SELECTION = _PHI_E_SELECTION(self, Access.RW, 0x0052, False)
            self.PHI_E = _PHI_E(self, Access.R, 0x0053, True)
            self.PID_FLUX_P_FLUX_I = _PID_FLUX_P_FLUX_I(self, Access.RW, 0x0054, False)
            self.PID_TORQUE_P_TORQUE_I = _PID_TORQUE_P_TORQUE_I(self, Access.RW, 0x0056, False)
            self.PID_VELOCITY_P_VELOCITY_I = _PID_VELOCITY_P_VELOCITY_I(self, Access.RW, 0x0058, False)
            self.PID_POSITION_P_POSITION_I = _PID_POSITION_P_POSITION_I(self, Access.RW, 0x005A, False)
            self.PIDOUT_UQ_UD_LIMITS = _PIDOUT_UQ_UD_LIMITS(self, Access.RW, 0x005D, False)
            self.PID_TORQUE_FLUX_LIMITS = _PID_TORQUE_FLUX_LIMITS(self, Access.RW, 0x005E, False)
            self.PID_VELOCITY_LIMIT = _PID_VELOCITY_LIMIT(self, Access.RW, 0x0060, False)
            self.PID_POSITION_LIMIT_LOW = _PID_POSITION_LIMIT_LOW(self, Access.RW, 0x0061, True)
            self.PID_POSITION_LIMIT_HIGH = _PID_POSITION_LIMIT_HIGH(self, Access.RW, 0x0062, True)
            self.MODE_RAMP_MODE_MOTION = _MODE_RAMP_MODE_MOTION(self, Access.RW, 0x0063, False)
            self.PID_TORQUE_FLUX_TARGET = _PID_TORQUE_FLUX_TARGET(self, Access.RW, 0x0064, False)
            self.PID_TORQUE_FLUX_OFFSET = _PID_TORQUE_FLUX_OFFSET(self, Access.RW, 0x0065, False)
            self.PID_VELOCITY_TARGET = _PID_VELOCITY_TARGET(self, Access.RW, 0x0066, True)
            self.PID_VELOCITY_OFFSET = _PID_VELOCITY_OFFSET(self, Access.RW, 0x0067, True)
            self.PID_POSITION_TARGET = _PID_POSITION_TARGET(self, Access.RW, 0x0068, True)
            self.PID_TORQUE_FLUX_ACTUAL = _PID_TORQUE_FLUX_ACTUAL(self, Access.R, 0x0069, False)
            self.PID_VELOCITY_ACTUAL = _PID_VELOCITY_ACTUAL(self, Access.R, 0x006A, True)
            self.PID_POSITION_ACTUAL = _PID_POSITION_ACTUAL(self, Access.RW, 0x006B, True)
            self.PID_ERROR_DATA = _PID_ERROR_DATA(self, Access.R, 0x006C, True)
            self.PID_ERROR_ADDR = _PID_ERROR_ADDR(self, Access.RW, 0x006D, False)
            self.INTERIM_DATA = _INTERIM_DATA(self, Access.R, 0x006E, True)
            self.INTERIM_ADDR = _INTERIM_ADDR(self, Access.RW, 0x006F, False)
            self.WATCHDOG_CFG = _WATCHDOG_CFG(self, Access.RW, 0x0074, False)
            self.ADC_VM_LIMITS = _ADC_VM_LIMITS(self, Access.RW, 0x0075, False)
            self.TMC4671_INPUTS_RAW = _TMC4671_INPUTS_RAW(self, Access.R, 0x0076, False)
            self.TMC4671_OUTPUTS_RAW = _TMC4671_OUTPUTS_RAW(self, Access.R, 0x0077, False)
            self.STEP_WIDTH = _STEP_WIDTH(self, Access.RW, 0x0078, True)
            self.UART_BPS = _UART_BPS(self, Access.RW, 0x0079, False)
            self.UART_ADDRS = _UART_ADDRS(self, Access.RW, 0x007A, False)
            self.GPIO_dsADCI_CONFIG = _GPIO_dsADCI_CONFIG(self, Access.RW, 0x007B, False)
            self.STATUS_FLAGS = _STATUS_FLAGS(self, Access.RW, 0x007C, False)
            self.STATUS_MASK = _STATUS_MASK(self, Access.RW, 0x007D, False)
