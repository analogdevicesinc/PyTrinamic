...
class TMC2262(TMCIc):
    """
        The TMC2262 is a smart high-power single axis stepper motor driver IC with SPI communication interface.
    ...
    class REG:
        """
        Define all registers of the TMC2262.
    ...
    class FIELD:
        """
        Define all register bitfields of the TMC2262.
