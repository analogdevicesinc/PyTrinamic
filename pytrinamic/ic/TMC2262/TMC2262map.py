...
class _ALL_REGISTERS(RegisterGroup):
    def __init__(self, channel, block, width):
        ...
        self.DO_DAC_CONF                =  self._DO_DAC_CONF(              self,  Access.RW,   0x0003,  False)
    ...
    class _DO_DAC_CONF(Register):
        def __init__(self, parent, access, address, signed):
            super().__init__("DO_DAC_CONF", parent, access, address, signed)
            self.DO0_DAC_EN   =  self._DO0_DAC_EN( self,  Access.RW,  0x00000001,  0,   signed=False)
            self.DO0_DAC_SEL  =  self._DO0_DAC_SEL(self,  Access.RW,  0x000001F0,  4,   signed=False)
            self.DO1_DAC_EN   =  self._DO1_DAC_EN( self,  Access.RW,  0x00001000,  12,  signed=False)
            self.DO1_DAC_SEL  =  self._DO1_DAC_SEL(self,  Access.RW,  0x001F0000,  16,  signed=False)

        class _DO0_DAC_EN(Field):
            class _Choice(Choice):
                def __init__(self, parent) -> None:
                    super().__init__(parent)
                    self.DISABLED  =  Option(False,  parent,  "DISABLED")
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("DO0_DAC_EN", parent, access, mask, shift, signed=signed)

                self.choice = self._Choice(self)

        class _DO0_DAC_SEL(Field):
            class _Choice(Choice):
                def __init__(self, parent) -> None:
                    super().__init__(parent)
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("DO0_DAC_SEL", parent, access, mask, shift, signed=signed)

                self.choice = self._Choice(self)

        class _DO1_DAC_EN(Field):
            class _Choice(Choice):
                def __init__(self, parent) -> None:
                    super().__init__(parent)
                    self.DISABLED  =  Option(False,  parent,  "DISABLED")
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("DO1_DAC_EN", parent, access, mask, shift, signed=signed)

                self.choice = self._Choice(self)

        class _DO1_DAC_SEL(Field):
            class _Choice(Choice):
                def __init__(self, parent) -> None:
                    super().__init__(parent)
                    self.ADC_I_A        =  Option(0,   parent,  "ADC_I_A")
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("DO1_DAC_SEL", parent, access, mask, shift, signed=signed)
        ...
        class _EVENT_STOP_SG(Field):
            class _Choice(Choice):
                def __init__(self, parent) -> None:
                    ...
                    self.STALL_DETECTED  =  Option(True,   parent,  "STALL_DETECTED")
