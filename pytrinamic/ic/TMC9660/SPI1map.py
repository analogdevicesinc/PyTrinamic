...
class _ALL_REGISTERS(RegisterGroup):
    ...
    class _SPI1_STATUS(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_STATUS", parent, access, address, block, signed)
    ...
    class _SPI1_GEN_CONFIG(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_GEN_CONFIG", parent, access, address, block, signed)
    ...
    class _SPI1_SCLK_CONFIG0(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_SCLK_CONFIG0", parent, access, address, block, signed)
    ...
    class _SPI1_SYNC_CONFIG0(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_SYNC_CONFIG0", parent, access, address, block, signed)
    ...
    class _SPI1_TRANSFER_CONFIG0(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_TRANSFER_CONFIG0", parent, access, address, block, signed)
    ...
    class _SPI1_RD_BUFFER0(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_RD_BUFFER0", parent, access, address, block, signed)
            self.RD_BUFFER0  =  self._RD_BUFFER0(self,  Access.R,  0xFFFFFFFF,  0,  signed=False)

    class _SPI1_RD_BUFFER1(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_RD_BUFFER1", parent, access, address, block, signed)
            self.RD_BUFFER1  =  self._RD_BUFFER1(self,  Access.R,  0xFFFFFFFF,  0,  signed=False)

    class _SPI1_RD_BUFFER2(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_RD_BUFFER2", parent, access, address, block, signed)
            self.RD_BUFFER2  =  self._RD_BUFFER2(self,  Access.R,  0xFFFFFFFF,  0,  signed=False)

    class _SPI1_RD_BUFFER3(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_RD_BUFFER3", parent, access, address, block, signed)
            self.RD_BUFFER3  =  self._RD_BUFFER3(self,  Access.R,  0xFFFFFFFF,  0,  signed=False)

    class _SPI1_WR_BUFFER0(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_WR_BUFFER0", parent, access, address, block, signed)
            self.WR_BUFFER0  =  self._WR_BUFFER0(self,  Access.RW,  0xFFFFFFFF,  0,  signed=False)

    class _SPI1_WR_BUFFER1(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_WR_BUFFER1", parent, access, address, block, signed)
            self.WR_BUFFER1  =  self._WR_BUFFER1(self,  Access.RW,  0xFFFFFFFF,  0,  signed=False)

    class _SPI1_WR_BUFFER2(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_WR_BUFFER2", parent, access, address, block, signed)
            self.WR_BUFFER2  =  self._WR_BUFFER2(self,  Access.RW,  0xFFFFFFFF,  0,  signed=False)

    class _SPI1_WR_BUFFER3(Register):
        ...
        def __init__(self, parent, access, address, block, signed):
            super().__init__("SPI1_WR_BUFFER3", parent, access, address, block, signed)
            self.WR_BUFFER3  =  self._WR_BUFFER3(self,  Access.RW,  0xFFFFFFFF,  0,  signed=False)

    def __init__(self, block=None):
        super().__init__("ALL_REGISTERS", block)
        self.SPI1_STATUS            =  self._SPI1_STATUS(self,            Access.RWC,  0x0000,  block,  False)
        self.SPI1_GEN_CONFIG        =  self._SPI1_GEN_CONFIG(self,        Access.RW,   0x0001,  block,  False)
        self.SPI1_SCLK_CONFIG0      =  self._SPI1_SCLK_CONFIG0(self,      Access.RW,   0x0002,  block,  False)
        self.SPI1_SYNC_CONFIG0      =  self._SPI1_SYNC_CONFIG0(self,      Access.RW,   0x0003,  block,  False)
        self.SPI1_TRANSFER_CONFIG0  =  self._SPI1_TRANSFER_CONFIG0(self,  Access.RW,   0x0004,  block,  False)
        self.SPI1_RD_BUFFER0        =  self._SPI1_RD_BUFFER0(self,        Access.R,    0x000B,  block,  False)
        self.SPI1_RD_BUFFER1        =  self._SPI1_RD_BUFFER1(self,        Access.R,    0x000C,  block,  False)
        self.SPI1_RD_BUFFER2        =  self._SPI1_RD_BUFFER2(self,        Access.R,    0x000D,  block,  False)
        self.SPI1_RD_BUFFER3        =  self._SPI1_RD_BUFFER3(self,        Access.R,    0x000E,  block,  False)
        self.SPI1_WR_BUFFER0        =  self._SPI1_WR_BUFFER0(self,        Access.RW,   0x000F,  block,  False)
        self.SPI1_WR_BUFFER1        =  self._SPI1_WR_BUFFER1(self,        Access.RW,   0x0010,  block,  False)
        self.SPI1_WR_BUFFER2        =  self._SPI1_WR_BUFFER2(self,        Access.RW,   0x0011,  block,  False)
        self.SPI1_WR_BUFFER3        =  self._SPI1_WR_BUFFER3(self,        Access.RW,   0x0012,  block,  False)
