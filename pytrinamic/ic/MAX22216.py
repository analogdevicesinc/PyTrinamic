...
class MAX22216(TMCIc):
    ...
    class FIELD:
        ...
        STT0                  = ( 0x02, 0x00000800, 11 )
        STT1                  = ( 0x02, 0x00001000, 12 )
        STT2                  = ( 0x02, 0x00002000, 13 )
        STT3                  = ( 0x02, 0x00004000, 14 )
        ...
        VM_MONITOR            = ( 0x05, 0x00001FFF,  0 )
        VM_THLD_DOWN          = ( 0x06, 0x0000000F,  0 )
        VM_THLD_UP            = ( 0x06, 0x000000F0,  4 )
        F_AC_SCAN             = ( 0x07, 0x00000FFF,  0 )
        U_AC_SCAN             = ( 0x08, 0x00007FFF,  0 )
        ...
        SNSF_0                = ( 0x0E, 0x00000003,  0 )
        GAIN_0                = ( 0x0E, 0x0000000C,  2 )
        ...
        DPM_START_0           = ( 0x10, 0x000000FF,  0 )
        DPM_MIN_NBR_0         = ( 0x10, 0x00000F00,  8 )
        END_HIT_AUTO_0        = ( 0x10, 0x00001000, 12 )
        END_HIT_TO_HIZ_AUTO_0 = ( 0x10, 0x00002000, 13 )
        ...
        SNSF_1                = ( 0x1C, 0x00000003,  0 )
        GAIN_1                = ( 0x1C, 0x0000000C,  2 )
        ...
        DPM_START_1           = ( 0x1E, 0x000000FF,  0 )
        DPM_MIN_NBR_1         = ( 0x1E, 0x00000F00,  8 )
        END_HIT_AUTO_1        = ( 0x1E, 0x00001000, 12 )
        END_HIT_TO_HIZ_AUTO_1 = ( 0x1E, 0x00002000, 13 )
        ...
        SNSF_2                = ( 0x2A, 0x00000003,  0 )
        GAIN_2                = ( 0x2A, 0x0000000C,  2 )
        ...
        DPM_START_2           = ( 0x2C, 0x000000FF,  0 )
        DPM_MIN_NBR_2         = ( 0x2C, 0x00000F00,  8 )
        END_HIT_AUTO_2        = ( 0x2C, 0x00001000, 12 )
        END_HIT_TO_HIZ_AUTO_2 = ( 0x2C, 0x00002000, 13 )
        ...
        SNSF_3                = ( 0x38, 0x00000003,  0 )
        GAIN_3                = ( 0x38, 0x0000000C,  2 )
        ...
        DPM_START_3           = ( 0x3A, 0x000000FF,  0 )
        DPM_MIN_NBR_3         = ( 0x3A, 0x00000F00,  8 )
        END_HIT_AUTO_3        = ( 0x3A, 0x00001000, 12 )
        END_HIT_TO_HIZ_AUTO_3 = ( 0x3A, 0x00002000, 13 )
