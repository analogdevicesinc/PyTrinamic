...
_NODECONF_SENDDELAY_FIELD_CHOICES = TypedDict("_NODECONF_SENDDELAY_FIELD_CHOICES", {
    "8 bit times delay (no support for multiple nodes)": Option,
    "24 bit times delay": Option,
    "40 bit times delay": Option,
    "56 bit times delay": Option,
    "72 bit times delay": Option,
    "88 bit times delay": Option,
    "104 bit times delay": Option,
    "120 bit times delay": Option,
})
...
_RAMPMODE_RAMPMODE_FIELD_CHOICES = TypedDict("_RAMPMODE_RAMPMODE_FIELD_CHOICES", {
    "Position mode": Option,
    "Velocity mode (target +VMAX)": Option,
    "Velocity mode (target -VMAX": Option,
    "Hold mode": Option,
})
...
_ENCMODE_POS_NEG_EDGE_FIELD_CHOICES = TypedDict("_ENCMODE_POS_NEG_EDGE_FIELD_CHOICES", {
    "active N-Channel value": Option,
    "rising N-channel value": Option,
    "falling N-channel value": Option,
    "rising and falling N-channel value": Option,
})


_PWMCONF_PWM_FREQ_FIELD_CHOICES = TypedDict("_PWMCONF_PWM_FREQ_FIELD_CHOICES", {
    "fPWM=2/1024 fCLK (Reset default)": Option,
    "fPWM=2/683 fCLK": Option,
    "fPWM=2/512 fCLK": Option,
    "fPWM=2/410 fCLK": Option,
})
...
class _ALL_REGISTERS(RegisterGroup):
    ...
    class _NODECONF(Register):
        ...
        class _SENDDELAY(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                ...
                self.choice : _NODECONF_SENDDELAY_FIELD_CHOICES = {
                    "8 bit times delay (no support for multiple nodes)": Option(0, self),
                    "24 bit times delay": Option(2, self),
                    "40 bit times delay": Option(4, self),
                    "56 bit times delay": Option(6, self),
                    "72 bit times delay": Option(8, self),
                    "88 bit times delay": Option(10, self),
                    "104 bit times delay": Option(12, self),
                    "120 bit times delay": Option(14, self),
                }
    ...
    class _IOIN(Register):
        ...
        class _COMP_A(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("COMP_A", parent, access, mask, shift, signed=signed)
        ...
        class _COMP_B(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("COMP_B", parent, access, mask, shift, signed=signed)

                self.choice = None

        class _COMP_A1_A2(Field):

            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("COMP_A1_A2", parent, access, mask, shift, signed=signed)

                self.choice = None

        class _COMP_B1_B2(Field):

            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("COMP_B1_B2", parent, access, mask, shift, signed=signed)
        ...
        class _ADC_ERR(Field):

            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("ADC_ERR", parent, access, mask, shift, signed=signed)
        ...
        def __init__(self, parent, access, address, signed):
            ...
            self.COMP_A       =  self._COMP_A(     self,  Access.R,   0x00000100,  8,   signed=False)
            self.COMP_B       =  self._COMP_B(     self,  Access.R,   0x00000200,  9,   signed=False)
            self.COMP_A1_A2   =  self._COMP_A1_A2( self,  Access.R,   0x00000400,  10,  signed=False)
            self.COMP_B1_B2   =  self._COMP_B1_B2( self,  Access.R,   0x00000800,  11,  signed=False)
            ...
            self.ADC_ERR      =  self._ADC_ERR(    self,  Access.R,   0x00008000,  15,  signed=False)
        ...
        class _RAMPMODE(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                ...
                self.choice : _RAMPMODE_RAMPMODE_FIELD_CHOICES = {
                    "Position mode": Option(0, self),
                    "Velocity mode (target +VMAX)": Option(1, self),
                    "Velocity mode (target -VMAX": Option(2, self),
                    "Hold mode": Option(3, self),
                }
    ...
    class _VDCMIN(Register):
        ...
        def __init__(self, parent, access, address, signed):
            ...
            self.RESERVED  =  self._RESERVED(self,  Access.R,   0x000000FF,  0,  signed=False)
            self.VDCMIN    =  self._VDCMIN(  self,  Access.RW,  0x007FFF00,  8,  signed=False)
        ...
        class _POS_NEG_EDGE(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                ...
                self.choice : _ENCMODE_POS_NEG_EDGE_FIELD_CHOICES = {
                    "active N-Channel value": Option(0, self),
                    "rising N-channel value": Option(1, self),
                    "falling N-channel value": Option(2, self),
                    "rising and falling N-channel value": Option(3, self),
                }
    ...
    class _CHOPCONF(Register):
        ...
        class _DISS2G(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("DISS2G", parent, access, mask, shift, signed=signed)

                self.choice = None

        class _DISS2VS(Field):

            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("DISS2VS", parent, access, mask, shift, signed=signed)
        ...
        def __init__(self, parent, access, address, signed):
            ...
            self.DISS2G        =  self._DISS2G(      self,  Access.RW,  0x40000000,  30,  signed=False)
            self.DISS2VS       =  self._DISS2VS(     self,  Access.RW,  0x80000000,  31,  signed=False)
        ...
        class _PWM_FREQ(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                ...
                self.choice : _PWMCONF_PWM_FREQ_FIELD_CHOICES = {
                    "fPWM=2/1024 fCLK (Reset default)": Option(0, self),
                    "fPWM=2/683 fCLK": Option(1, self),
                    "fPWM=2/512 fCLK": Option(2, self),
                    "fPWM=2/410 fCLK": Option(3, self),
                }
