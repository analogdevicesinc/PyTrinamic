...
class _ALL_REGISTERS(RegisterGroup):
    ...
    class _GCR_NODECONF(Register):

        class _I2C_AUT_INC(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("I2C_AUT_INC", parent, access, mask, shift, signed=signed)

                self.choice = self._Choice(self)

        def __init__(self, parent, access, address, signed):
            super().__init__("GCR_NODECONF", parent, access, address, signed)
            self.I2C_AUT_INC  =  self._I2C_AUT_INC(self,  Access.RW,  0x00000001,  0,  signed=False)
    ...
    class _ER_BEMF_CONF(Register):
        ...
        class _QSC_ENC_EN(Field):
            ...
            def __init__(self, parent, access, mask, shift, signed):
                super().__init__("QSC_ENC_EN", parent, access, mask, shift, signed=signed)
        ...
        def __init__(self, parent, access, address, signed):
            ...
            self.QSC_ENC_EN       =  self._QSC_ENC_EN(     self,  Access.RW,  0x00000008,  3,   signed=False)
        ...
        class _MRES(Field):
            ...
            class _Choice(Choice):
                def __init__(self, parent) -> None:
                    ...
                    self.UNUSED_9  =  Option(9,   parent,  "UNUSED_9")
                    self.UNUSED_A  =  Option(10,  parent,  "UNUSED_A")
                    self.UNUSED_B  =  Option(11,  parent,  "UNUSED_B")
                    self.UNUSED_C  =  Option(12,  parent,  "UNUSED_C")
                    self.UNUSED_D  =  Option(13,  parent,  "UNUSED_D")
                    self.UNUSED_E  =  Option(14,  parent,  "UNUSED_E")
                    self.UNUSED_F  =  Option(15,  parent,  "UNUSED_F")
    ...
    def __init__(self, channel, block, width):
        ...
        self.GCR_NODECONF                         =  self._GCR_NODECONF(                       self,  Access.RW,   0x0003,  False)
