...
sample_rate = 25_000  # configure you targets sampling rate, 25kHz is the default PWM frequency for TMC9660 and TMC4671 
...
if plot_bode:
    ...
    z = ct.tf([1, 0], [0, 1], dt=down_sampling_factor/sample_rate)
    ...
    mag_ax.legend()
    mag_ax.set_xlim([10, sample_rate/2])
    phase_ax.legend()
    phase_ax.set_xlim([10, sample_rate/2])
    plt.show()
