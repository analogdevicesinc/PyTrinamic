...
with ConnectionManager().connect() as my_interface:
    ...
    module = TMCM1311(my_interface)
    motor = module.motors[0]

    print("Preparing parameters...")

    # preparing drive settings
    motor.drive_settings.max_current = 32
    ...
    motor.set_axis_parameter(motor.AP.EncoderInitialization, 1)
    while motor.get_axis_parameter(motor.AP.EncoderInitialization)!=2:
      time.sleep(1)
    print("Encoder resolution = {}".format(motor.get_axis_parameter(motor.AP.EncoderResolution)))
      
    #switch on closed loop mode
    motor.set_axis_parameter(motor.AP.ClosedLoopMode, 1)
    while motor.get_axis_parameter(motor.AP.CLInitFlag)!=1:
      time.sleep(1)
    ...
    # start rotating motor for 5 seconds
    print("Rotating...")
    motor.rotate(20000)
    time.sleep(5)
