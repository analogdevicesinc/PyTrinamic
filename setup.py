...
setuptools.setup(
    ...
    py_modules=["PyTrinamic/connections/connection_interface",
                ...
                "PyTrinamic/examples/evalboards/TMC4671_eval_TMC6200_eval_BLDC_ABN_encoder",
                "PyTrinamic/examples/evalboards/TMC4671_eval_TMC6200_eval_BLDC_open_loop",
                "PyTrinamic/examples/evalboards/TMC4672_eval_template",
