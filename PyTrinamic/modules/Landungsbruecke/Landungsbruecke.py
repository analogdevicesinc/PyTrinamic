...
class Landungsbruecke():
    ...
    def detectBoardIDs(self):
        ...
        while not self.__connection.send_receive(TMCL_Command.ASSIGNMENT, 0, 0, 0).isValid():
            pass
    ...
    def _readMcEeprom(self, address):
        reply = self.__connection.send_receive(TMCL_Command.TMCL_UF1, 1, 0, address)
    ...
    def _writeMcEeprom(self, address, value):
        self.__connection.send_receive(TMCL_Command.TMCL_UF2, 1, value, address)

    def _readDrvEeprom(self, address):
        reply = self.__connection.send_receive(TMCL_Command.TMCL_UF1, 2, 0, address)
    ...
    def _writeDrvEeprom(self, address, value):
        self.__connection.send_receive(TMCL_Command.TMCL_UF2, 2, value & 0xFF, address)
