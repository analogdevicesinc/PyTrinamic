...
class test_TMC5130_TMCL(object):
    ...
    def __init__(self, cm):
        ...
        self.__test.add_output_callbacks(json_factory.OutputToJSON('./{dut_id}.%(name)s.json' % {"name": self.__class__.__name__}, indent=2))
        self.__interface = None
        self.__cm = cm
        self.__register_tests = args.register_tests[0]
        self.__tmc5130 = None
