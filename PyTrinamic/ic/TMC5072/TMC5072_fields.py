...
class TMC5072_fields(object):
    ...
    # PWMCONF_M1
    PWM_AMPL_M1        = ( 0x10, 0x000000FF,  0 ) # PWMCONF_M1
    PWM_GRAD_M1        = ( 0x10, 0x0000FF00,  8 ) # PWMCONF_M1
    PWM_FREQ_M1        = ( 0x10, 0x00030000, 16 ) # PWMCONF_M1
    PWM_AUTOSCALE_M1   = ( 0x10, 0x00040000, 18 ) # PWMCONF_M1
    PWM_SYMMETRIC_M1   = ( 0x10, 0x00080000, 19 ) # PWMCONF_M1
    FREEWHEEL_M1       = ( 0x10, 0x00300000, 20 ) # PWMCONF_M1
    PWM_AMPL_M1        = ( 0x10, 0x000000FF,  0 ) # PWMCONF_M1
    PWM_GRAD_M1        = ( 0x10, 0x0000FF00,  8 ) # PWMCONF_M1
    PWM_FREQ_M1        = ( 0x10, 0x00030000, 16 ) # PWMCONF_M1
    PWM_AUTOSCALE_M1   = ( 0x10, 0x00040000, 18 ) # PWMCONF_M1
    ...
    # PWM_STATUS_M1
    PWM_STATUS_M1         = ( 0x11, 0x000000FF,  0 ) # PWM_STATUS_M1

    # PWMCONF_M2
    PWM_AMPL_M2           = ( 0x18, 0x000000FF,  0 ) # PWMCONF_M2
    PWM_GRAD_M2           = ( 0x18, 0x0000FF00,  8 ) # PWMCONF_M2
    PWM_FREQ_M2           = ( 0x18, 0x00030000, 16 ) # PWMCONF_M2
    PWM_AUTOSCALE_M2      = ( 0x18, 0x00040000, 18 ) # PWMCONF_M2
    PWM_SYMMETRIC_M2      = ( 0x18, 0x00080000, 19 ) # PWMCONF_M2
    FREEWHEEL_M2          = ( 0x18, 0x00300000, 20 ) # PWMCONF_M2
    PWM_AMPL_M2           = ( 0x18, 0x000000FF,  0 ) # PWMCONF_M2
    PWM_GRAD_M2           = ( 0x18, 0x0000FF00,  8 ) # PWMCONF_M2
    PWM_FREQ_M2           = ( 0x18, 0x00030000, 16 ) # PWMCONF_M2
    PWM_AUTOSCALE_M2      = ( 0x18, 0x00040000, 18 ) # PWMCONF_M2
    ...
    # PWM_STATUS_M2
    PWM_STATUS_M2         = ( 0x19, 0x000000FF,  0 ) # PWM_STATUS_M2

    # RAMPMODE_M1
    RAMPMODE_M1           = ( 0x20, 0x00000003,  0 ) # RAMPMODE_M1

    # XACTUAL_M1
    XACTUAL_M1            = ( 0x21, 0xFFFFFFFF,  0 ) # XACTUAL_M1

    # VACTUAL_M1
    VACTUAL_M1            = ( 0x22, 0x00FFFFFF,  0 ) # VACTUAL_M1

    # VSTART_M1
    VSTART_M1             = ( 0x23, 0x0003FFFF,  0 ) # VSTART_M1

    # A1_M1
    A1_M1                 = ( 0x24, 0x0000FFFF,  0 ) # A1_M1

    # V1_M1
    V1_M1                = ( 0x25, 0x000FFFFF,  0 ) # V1_M1

    # AMAX_M1
    AMAX_M1               = ( 0x26, 0x0000FFFF,  0 ) # AMAX_M1

    # VMAX_M1
    VMAX_M1               = ( 0x27, 0x007FFFFF,  0 ) # VMAX_M1

    # DMAX_M1
    DMAX_M1               = ( 0x28, 0x0000FFFF,  0 ) # DMAX_M1

    # D1_M1
    D1_M1                 = ( 0x2A, 0x0000FFFF,  0 ) # D1_M1

    # VSTOP_M1
    VSTOP_M1              = ( 0x2B, 0x0003FFFF,  0 ) # VSTOP_M1

    # TZEROWAIT_M1
    TZEROWAIT_M1          = ( 0x2C, 0x0000FFFF,  0 ) # TZEROWAIT_M1

    # XTARGET_M1
    XTARGET_M1            = ( 0x2D, 0xFFFFFFFF,  0 ) # XTARGET_M1

    # RAMPMODE_M2
    RAMPMODE_M2           = ( 0x40, 0x00000003,  0 ) # RAMPMODE_M2

    # XACTUAL_M2
    XACTUAL_M2            = ( 0x41, 0xFFFFFFFF,  0 ) # XACTUAL_M2

    # VACTUAL_M2
    VACTUAL_M2            = ( 0x42, 0x00FFFFFF,  0 ) # VACTUAL_M2

    # VSTART_M2
    VSTART_M2             = ( 0x43, 0x0003FFFF,  0 ) # VSTART_M2

    # A1_M2
    A1_M2                 = ( 0x44, 0x0000FFFF,  0 ) # A1_M2

    # V1_M2
    V1_M2                = ( 0x45, 0x000FFFFF,  0 ) # V1_M2

    # AMAX_M2
    AMAX_M2               = ( 0x46, 0x0000FFFF,  0 ) # AMAX_M2

    # VMAX_M2
    VMAX_M2               = ( 0x47, 0x007FFFFF,  0 ) # VMAX_M2

    # DMAX_M2
    DMAX_M2               = ( 0x48, 0x0000FFFF,  0 ) # DMAX_M2

    # D1_M2
    D1_M2                 = ( 0x4A, 0x0000FFFF,  0 ) # D1_M2

    # VSTOP_M2
    VSTOP_M2              = ( 0x4B, 0x0003FFFF,  0 ) # VSTOP_M2

    # TZEROWAIT_M2
    TZEROWAIT_M2          = ( 0x4C, 0x0000FFFF,  0 ) # TZEROWAIT_M2

    # XTARGET_M2
    XTARGET_M2            = ( 0x4D, 0xFFFFFFFF,  0 ) # XTARGET_M2

    # IHOLD_IRUN_M1
    IHOLD_M1              = ( 0x30, 0x0000001F,  0 ) # IHOLD_IRUN_M1
    IRUN_M1               = ( 0x30, 0x00001F00,  8 ) # IHOLD_IRUN_M1
    IHOLDDELAY_M1         = ( 0x30, 0x000F0000, 16 ) # IHOLD_IRUN_M1

    # VCOOLTHRS_M1
    VCOOLTHRS_M1          = ( 0x31, 0x007FFFFF,  0 ) # VCOOLTHRS_M1

    # VHIGH_M1
    VHIGH_M1              = ( 0x32, 0x007FFFFF,  0 ) # VHIGH_M1

    # VDCMIN_M1
    VDCMIN_M1             = ( 0x33, 0x007FFFFF,  0 ) # VDCMIN_M1

    # SW_MODE_M1
    STOP_L_ENABLE_M1      = ( 0x34, 0x00000001,  0 ) # SW_MODE_M1
    STOP_R_ENABLE_M1      = ( 0x34, 0x00000002,  1 ) # SW_MODE_M1
    POL_STOP_L_M1         = ( 0x34, 0x00000004,  2 ) # SW_MODE_M1
    POL_STOP_R_M1         = ( 0x34, 0x00000008,  3 ) # SW_MODE_M1
    SWAP_LR_M1            = ( 0x34, 0x00000010,  4 ) # SW_MODE_M1
    LATCH_L_ACTIVE_M1     = ( 0x34, 0x00000020,  5 ) # SW_MODE_M1
    LATCH_L_INACTIVE_M1   = ( 0x34, 0x00000040,  6 ) # SW_MODE_M1
    LATCH_R_ACTIVE_M1     = ( 0x34, 0x00000080,  7 ) # SW_MODE_M1
    LATCH_R_INACTIVE_M1   = ( 0x34, 0x00000100,  8 ) # SW_MODE_M1
    EN_LATCH_ENCODER_M1   = ( 0x34, 0x00000200,  9 ) # SW_MODE_M1
    SG_STOP_M1            = ( 0x34, 0x00000400, 10 ) # SW_MODE_M1
    EN_SOFTSTOP_M1        = ( 0x34, 0x00000800, 11 ) # SW_MODE_M1

    # RAMP_STAT_M1
    STATUS_STOP_L_M1      = ( 0x35, 0x00000001,  0 ) # RAMP_STAT_M1
    STATUS_STOP_R_M1      = ( 0x35, 0x00000002,  1 ) # RAMP_STAT_M1
    STATUS_LATCH_L_M1     = ( 0x35, 0x00000004,  2 ) # RAMP_STAT_M1
    STATUS_LATCH_R_M1     = ( 0x35, 0x00000008,  3 ) # RAMP_STAT_M1
    EVENT_STOP_L_M1       = ( 0x35, 0x00000010,  4 ) # RAMP_STAT_M1
    EVENT_STOP_R_M1       = ( 0x35, 0x00000020,  5 ) # RAMP_STAT_M1
    EVENT_STOP_SG_M1      = ( 0x35, 0x00000040,  6 ) # RAMP_STAT_M1
    EVENT_POS_REACHED_M1  = ( 0x35, 0x00000080,  7 ) # RAMP_STAT_M1
    VELOCITY_REACHED_M1   = ( 0x35, 0x00000100,  8 ) # RAMP_STAT_M1
    POSITION_REACHED_M1   = ( 0x35, 0x00000200,  9 ) # RAMP_STAT_M1
    VZERO_M1              = ( 0x35, 0x00000400, 10 ) # RAMP_STAT_M1
    T_ZEROWAIT_ACTIVE_M1  = ( 0x35, 0x00000800, 11 ) # RAMP_STAT_M1
    SECOND_MOVE_M1        = ( 0x35, 0x00001000, 12 ) # RAMP_STAT_M1
    STATUS_SG_M1          = ( 0x35, 0x00002000, 13 ) # RAMP_STAT_M1

    # XLATCH_M1
    XLATCH_M1             = ( 0x36, 0xFFFFFFFF,  0 ) # XLATCH_M1

    # IHOLD_IRUN_M2
    IHOLD_M2              = ( 0x50, 0x0000001F,  0 ) # IHOLD_IRUN_M2
    IRUN_M2               = ( 0x50, 0x00001F00,  8 ) # IHOLD_IRUN_M2
    IHOLDDELAY_M2         = ( 0x50, 0x000F0000, 16 ) # IHOLD_IRUN_M2

    # VCOOLTHRS_M2
    VCOOLTHRS_M2          = ( 0x51, 0x007FFFFF,  0 ) # VCOOLTHRS_M2

    # VHIGH_M2
    VHIGH_M2              = ( 0x52, 0x007FFFFF,  0 ) # VHIGH_M2

    # VDCMIN_M2
    VDCMIN_M2             = ( 0x53, 0x007FFFFF,  0 ) # VDCMIN_M2

    # SW_MODE_M2
    STOP_L_ENABLE_M2      = ( 0x54, 0x00000001,  0 ) # SW_MODE_M2
    STOP_R_ENABLE_M2      = ( 0x54, 0x00000002,  1 ) # SW_MODE_M2
    POL_STOP_L_M2         = ( 0x54, 0x00000004,  2 ) # SW_MODE_M2
    POL_STOP_R_M2         = ( 0x54, 0x00000008,  3 ) # SW_MODE_M2
    SWAP_LR_M2            = ( 0x54, 0x00000010,  4 ) # SW_MODE_M2
    LATCH_L_ACTIVE_M2     = ( 0x54, 0x00000020,  5 ) # SW_MODE_M2
    LATCH_L_INACTIVE_M2   = ( 0x54, 0x00000040,  6 ) # SW_MODE_M2
    LATCH_R_ACTIVE_M2     = ( 0x54, 0x00000080,  7 ) # SW_MODE_M2
    LATCH_R_INACTIVE_M2   = ( 0x54, 0x00000100,  8 ) # SW_MODE_M2
    EN_LATCH_ENCODER_M2   = ( 0x54, 0x00000200,  9 ) # SW_MODE_M2
    SG_STOP_M2            = ( 0x54, 0x00000400, 10 ) # SW_MODE_M2
    EN_SOFTSTOP_M2        = ( 0x54, 0x00000800, 11 ) # SW_MODE_M2

    # RAMP_STAT_M2
    STATUS_STOP_L_M2      = ( 0x55, 0x00000001,  0 ) # RAMP_STAT_M2
    STATUS_STOP_R_M2      = ( 0x55, 0x00000002,  1 ) # RAMP_STAT_M2
    STATUS_LATCH_L_M2     = ( 0x55, 0x00000004,  2 ) # RAMP_STAT_M2
    STATUS_LATCH_R_M2     = ( 0x55, 0x00000008,  3 ) # RAMP_STAT_M2
    EVENT_STOP_L_M2       = ( 0x55, 0x00000010,  4 ) # RAMP_STAT_M2
    EVENT_STOP_R_M2       = ( 0x55, 0x00000020,  5 ) # RAMP_STAT_M2
    EVENT_STOP_SG_M2      = ( 0x55, 0x00000040,  6 ) # RAMP_STAT_M2
    EVENT_POS_REACHED_M2  = ( 0x55, 0x00000080,  7 ) # RAMP_STAT_M2
    VELOCITY_REACHED_M2   = ( 0x55, 0x00000100,  8 ) # RAMP_STAT_M2
    POSITION_REACHED_M2   = ( 0x55, 0x00000200,  9 ) # RAMP_STAT_M2
    VZERO_M2              = ( 0x55, 0x00000400, 10 ) # RAMP_STAT_M2
    T_ZEROWAIT_ACTIVE_M2  = ( 0x55, 0x00000800, 11 ) # RAMP_STAT_M2
    SECOND_MOVE_M2        = ( 0x55, 0x00001000, 12 ) # RAMP_STAT_M2
    STATUS_SG_M2          = ( 0x55, 0x00002000, 13 ) # RAMP_STAT_M2

    # XLATCH_M2
    XLATCH_M2             = ( 0x56, 0xFFFFFFFF,  0 ) # XLATCH_M2

    # ENCMODE_M1
    POL_A_M1              = ( 0x38, 0x00000001,  0 ) # ENCMODE_M1
    POL_B_M1              = ( 0x38, 0x00000002,  1 ) # ENCMODE_M1
    POL_N_M1              = ( 0x38, 0x00000004,  2 ) # ENCMODE_M1
    IGNORE_AB_M1          = ( 0x38, 0x00000008,  3 ) # ENCMODE_M1
    CLR_CONT_M1           = ( 0x38, 0x00000010,  4 ) # ENCMODE_M1
    CLR_ONCE_M1           = ( 0x38, 0x00000020,  5 ) # ENCMODE_M1
    POS_EDGE_NEG_EDGE_M1  = ( 0x38, 0x000000C0,  6 ) # ENCMODE_M1
    CLR_ENC_X_M1          = ( 0x38, 0x00000100,  8 ) # ENCMODE_M1
    LATCH_X_ACT_M1        = ( 0x38, 0x00000200,  9 ) # ENCMODE_M1
    ENC_SEL_DECIMAL_M1    = ( 0x38, 0x00000400, 10 ) # ENCMODE_M1
    LATCH_NOW_M1         = ( 0x38, 0x00000800, 11 ) # ENCMODE_M1

    # X_ENC_M1
    X_ENC_M1              = ( 0x39, 0xFFFFFFFF,  0 ) # X_ENC_M1

    # ENC_CONST_M1
    INTEGER_M1            = ( 0x3A, 0xFFFF0000, 16 ) # ENC_CONST_M1
    FRACTIONAL_M1         = ( 0x3A, 0x0000FFFF,  0 ) # ENC_CONST_M1

    # ENC_STATUS_M1
    ENC_STATUS_M1         = ( 0x3B, 0x00000001,  0 ) # ENC_STATUS_M1

    # ENC_LATCH_M1
    ENC_LATCH_M1          = ( 0x3C, 0xFFFFFFFF,  0 ) # ENC_LATCH_M1

    # ENCMODE_M2
    POL_A_M2              = ( 0x58, 0x00000001,  0 ) # ENCMODE_M2
    POL_B_M2              = ( 0x58, 0x00000002,  1 ) # ENCMODE_M2
    POL_N_M2              = ( 0x58, 0x00000004,  2 ) # ENCMODE_M2
    IGNORE_AB_M2          = ( 0x58, 0x00000008,  3 ) # ENCMODE_M2
    CLR_CONT_M2           = ( 0x58, 0x00000010,  4 ) # ENCMODE_M2
    CLR_ONCE_M2           = ( 0x58, 0x00000020,  5 ) # ENCMODE_M2
    POS_EDGE_NEG_EDGE_M2  = ( 0x58, 0x000000C0,  6 ) # ENCMODE_M2
    CLR_ENC_X_M2          = ( 0x58, 0x00000100,  8 ) # ENCMODE_M2
    LATCH_X_ACT_M2        = ( 0x58, 0x00000200,  9 ) # ENCMODE_M2
    ENC_SEL_DECIMAL_M2    = ( 0x58, 0x00000400, 10 ) # ENCMODE_M2
    LATCH_NOW_M2         = ( 0x58, 0x00000800, 11 ) # ENCMODE_M2

    # X_ENC_M2
    X_ENC_M2              = ( 0x59, 0xFFFFFFFF,  0 ) # X_ENC_M2

    # ENC_CONST_M2
    INTEGER_M2            = ( 0x5A, 0xFFFF0000, 16 ) # ENC_CONST_M2
    FRACTIONAL_M2         = ( 0x5A, 0x0000FFFF,  0 ) # ENC_CONST_M2

    # ENC_STATUS_M2
    ENC_STATUS_M2         = ( 0x5B, 0x00000001,  0 ) # ENC_STATUS_M2

    # ENC_LATCH_M2
    ENC_LATCH_M2          = ( 0x5C, 0xFFFFFFFF,  0 ) # ENC_LATCH_M2
    ...
    # MSCNT_M1
    MSCNT_M1              = ( 0x6A, 0x000003FF,  0 ) # MSCNT_M1

    # MSCURACT_M1
    CUR_A_M1              = ( 0x6B, 0x000001FF,  0 ) # MSCURACT_M1
    CUR_B_M1              = ( 0x6B, 0x01FF0000, 16 ) # MSCURACT_M1

    # CHOPCONF_M1
    TOFF_M1               = ( 0x6C, 0x0000000F,  0 ) # CHOPCONF_M1
    TFD_2_0_M1          = ( 0x6C, 0x00000070,  4 ) # CHOPCONF_M1
    OFFSET_M1             = ( 0x6C, 0x00000780,  7 ) # CHOPCONF_M1
    TFD_M1              = ( 0x6C, 0x00000800, 11 ) # CHOPCONF_M1
    DISFDCC_M1            = ( 0x6C, 0x00001000, 12 ) # CHOPCONF_M1
    RNDTF_M1              = ( 0x6C, 0x00002000, 13 ) # CHOPCONF_M1
    CHM_M1                = ( 0x6C, 0x00004000, 14 ) # CHOPCONF_M1
    TBL_M1                = ( 0x6C, 0x00018000, 15 ) # CHOPCONF_M1
    VSENSE_M1             = ( 0x6C, 0x00020000, 17 ) # CHOPCONF_M1
    VHIGHFS_M1            = ( 0x6C, 0x00040000, 18 ) # CHOPCONF_M1
    VHIGHCHM_M1           = ( 0x6C, 0x00080000, 19 ) # CHOPCONF_M1
    MRES_M1               = ( 0x6C, 0x0F000000, 24 ) # CHOPCONF_M1
    INTPOL_M1             = ( 0x6C, 0x10000000, 28 ) # CHOPCONF_M1
    DEDGE_M1              = ( 0x6C, 0x20000000, 29 ) # CHOPCONF_M1
    DISS2G_M1             = ( 0x6C, 0x40000000, 30 ) # CHOPCONF_M1

    # COOLCONF_M1
    SEMIN_M1              = ( 0x6D, 0x0000000F,  0 ) # COOLCONF_M1
    SEUP_M1               = ( 0x6D, 0x00000060,  5 ) # COOLCONF_M1
    SEMAX_M1              = ( 0x6D, 0x00000F00,  8 ) # COOLCONF_M1
    SEDN_M1               = ( 0x6D, 0x00006000, 13 ) # COOLCONF_M1
    SEIMIN_M1             = ( 0x6D, 0x00008000, 15 ) # COOLCONF_M1
    SGT_M1                = ( 0x6D, 0x007F0000, 16 ) # COOLCONF_M1
    SFILT_M1              = ( 0x6D, 0x01000000, 24 ) # COOLCONF_M1

    # DCCTRL_M1
    DC_TIME_M1            = ( 0x6E, 0x000003FF,  0 ) # DCCTRL_M1
    DC_SG_M1              = ( 0x6E, 0x00FF0000, 16 ) # DCCTRL_M1

    # DRV_STATUS_M1
    SG_RESULT_M1          = ( 0x6F, 0x000003FF,  0 ) # DRV_STATUS_M1
    FSACTIVE_M1           = ( 0x6F, 0x00008000, 15 ) # DRV_STATUS_M1
    CS_ACTUAL_M1          = ( 0x6F, 0x001F0000, 16 ) # DRV_STATUS_M1
    STALLGUARD_M1         = ( 0x6F, 0x01000000, 24 ) # DRV_STATUS_M1
    OT_M1                 = ( 0x6F, 0x02000000, 25 ) # DRV_STATUS_M1
    OTPW_M1               = ( 0x6F, 0x04000000, 26 ) # DRV_STATUS_M1
    S2GA_M1               = ( 0x6F, 0x08000000, 27 ) # DRV_STATUS_M1
    S2GB_M1               = ( 0x6F, 0x10000000, 28 ) # DRV_STATUS_M1
    OLA_M1                = ( 0x6F, 0x20000000, 29 ) # DRV_STATUS_M1
    OLB_M1                = ( 0x6F, 0x40000000, 30 ) # DRV_STATUS_M1
    STST_M1               = ( 0x6F, 0x80000000, 31 ) # DRV_STATUS_M1

    # MSCNT_M2
    MSCNT_M2              = ( 0x7A, 0x000003FF,  0 ) # MSCNT_M2

    # MSCURACT_M2
    CUR_A_M2              = ( 0x7B, 0x000001FF,  0 ) # MSCURACT_M2
    CUR_B_M2              = ( 0x7B, 0x01FF0000, 16 ) # MSCURACT_M2

    # CHOPCONF_M2
    TOFF_M2               = ( 0x7C, 0x0000000F,  0 ) # CHOPCONF_M2
    TFD_2_0_M2          = ( 0x7C, 0x00000070,  4 ) # CHOPCONF_M2
    OFFSET_M2             = ( 0x7C, 0x00000780,  7 ) # CHOPCONF_M2
    TFD_M2              = ( 0x7C, 0x00000800, 11 ) # CHOPCONF_M2
    DISFDCC_M2            = ( 0x7C, 0x00001000, 12 ) # CHOPCONF_M2
    RNDTF_M2              = ( 0x7C, 0x00002000, 13 ) # CHOPCONF_M2
    CHM_M2                = ( 0x7C, 0x00004000, 14 ) # CHOPCONF_M2
    TBL_M2                = ( 0x7C, 0x00018000, 15 ) # CHOPCONF_M2
    VSENSE_M2             = ( 0x7C, 0x00020000, 17 ) # CHOPCONF_M2
    VHIGHFS_M2            = ( 0x7C, 0x00040000, 18 ) # CHOPCONF_M2
    VHIGHCHM_M2           = ( 0x7C, 0x00080000, 19 ) # CHOPCONF_M2
    MRES_M2               = ( 0x7C, 0x0F000000, 24 ) # CHOPCONF_M2
    INTPOL_M2             = ( 0x7C, 0x10000000, 28 ) # CHOPCONF_M2
    DEDGE_M2              = ( 0x7C, 0x20000000, 29 ) # CHOPCONF_M2
    DISS2G_M2             = ( 0x7C, 0x40000000, 30 ) # CHOPCONF_M2

    # COOLCONF_M2
    SEMIN_M2              = ( 0x7D, 0x0000000F,  0 ) # COOLCONF_M2
    SEUP_M2               = ( 0x7D, 0x00000060,  5 ) # COOLCONF_M2
    SEMAX_M2              = ( 0x7D, 0x00000F00,  8 ) # COOLCONF_M2
    SEDN_M2               = ( 0x7D, 0x00006000, 13 ) # COOLCONF_M2
    SEIMIN_M2             = ( 0x7D, 0x00008000, 15 ) # COOLCONF_M2
    SGT_M2                = ( 0x7D, 0x007F0000, 16 ) # COOLCONF_M2
    SFILT_M2              = ( 0x7D, 0x01000000, 24 ) # COOLCONF_M2

    # DCCTRL_M2
    DC_TIME_M2            = ( 0x7E, 0x000003FF,  0 ) # DCCTRL_M2
    DC_SG_M2              = ( 0x7E, 0x00FF0000, 16 ) # DCCTRL_M2

    # DRV_STATUS_M2
    SG_RESULT_M2          = ( 0x7F, 0x000003FF,  0 ) # DRV_STATUS_M2
    FSACTIVE_M2           = ( 0x7F, 0x00008000, 15 ) # DRV_STATUS_M2
    CS_ACTUAL_M2          = ( 0x7F, 0x001F0000, 16 ) # DRV_STATUS_M2
    STALLGUARD_M2         = ( 0x7F, 0x01000000, 24 ) # DRV_STATUS_M2
    OT_M2                 = ( 0x7F, 0x02000000, 25 ) # DRV_STATUS_M2
    OTPW_M2               = ( 0x7F, 0x04000000, 26 ) # DRV_STATUS_M2
    S2GA_M2               = ( 0x7F, 0x08000000, 27 ) # DRV_STATUS_M2
    S2GB_M2               = ( 0x7F, 0x10000000, 28 ) # DRV_STATUS_M2
    OLA_M2                = ( 0x7F, 0x20000000, 29 ) # DRV_STATUS_M2
    OLB_M2                = ( 0x7F, 0x40000000, 30 ) # DRV_STATUS_M2
    STST_M2               = ( 0x7F, 0x80000000, 31 ) # DRV_STATUS_M2
