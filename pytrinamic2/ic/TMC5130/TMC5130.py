# General imports
from pytrinamic2.ic.TMC_IC import TMC_IC
from pytrinamic2.ic.TMC5130.TMC5130_register import TMC5130_register
from pytrinamic2.ic.TMC5130.TMC5130_fields import TMC5130_fields

# Feature imports
from pytrinamic2.features.MotorControlIC import MotorControlIC
from pytrinamic2.features.LinearRampIC import LinearRampIC
from pytrinamic2.features.CurrentIC import CurrentIC
from pytrinamic2.features.StallGuard2IC import StallGuard2IC

class TMC5130(TMC_IC):
    "TMC5130 IC implementation"
    # Constant registers, variants, fields
    REGISTERS = TMC5130_register
